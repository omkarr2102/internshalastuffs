...
$fname_error = $email_error = $password_error = $mobile_error = "";
$fname = $email = $lname = $password = $mobile = "";
...
if(isset($_SESSION['id'])!="") {
  header("Location: welcome.php");
    ...
    if (isset($_POST['create'])) {
        ...
        if(strlen($mobile) < 10) {
          $mobile_error = "mobile number should have 10 digits only";
          $error = +1;
        } 
        
        if (!$error) {
            if(mysqli_query($conn, "INSERT INTO `tbluser`(`Firstname`, `Lastname`, `email`, `password`, `mobile`) VALUES ('$fname','$lname','$email','$password','$mobile')")) {
...
<div class="form-group">
    ...
    <span class="error"> * </span>
    <div class="col-sm-6">
      <input type="txt" name="mobile" class="form-control" id="mobile" value="" placeholder="Enter mobile no" required="">
